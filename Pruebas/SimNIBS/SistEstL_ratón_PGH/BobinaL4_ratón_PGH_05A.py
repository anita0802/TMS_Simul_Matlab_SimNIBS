...
def spiral_core(outer_diam_core: float, segment_count: int):
    # Turns of the core
    N3=3        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h3=0.5           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_2(outer_diam_core2: float, segment_count: int):
    # Turns of the core
    N4=7        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h4=0.25           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_3(outer_diam_core3: float, segment_count: int):
    # Turns of the core
    N5=7        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h5=0.25           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_4(outer_diam_core4: float, segment_count: int):
    # Turns of the core
    N6=3        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h6=0.5           # PARÁMETRO QUE SE PUEDE VARIAR
...
radius_coil_helixin  = 0.000804167

outer_diam_core = 0.0005*1000                    # mm                  # PARÁMETRO QUE SE PUEDE VARIAR
outer_diam_core2 = 0.00038*1000
...
tms_coil.write("tcd/BobinaL4_ratón_PGH_05A.tcd")