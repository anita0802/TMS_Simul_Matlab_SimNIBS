...
def spiral_core(outer_diam_core: float, segment_count: int):
    ...
    h3=0.75           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_4(outer_diam_core4: float, segment_count: int):
    # Turns of the core
    N6=8        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h6=0.75           # PARÁMETRO QUE SE PUEDE VARIAR
...
tms_coil.write("tcd/BobinaL1_ratón_PGH_2A.tcd")