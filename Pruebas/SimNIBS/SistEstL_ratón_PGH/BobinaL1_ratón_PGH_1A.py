...
def spiral_core(outer_diam_core: float, segment_count: int):
    # Turns of the core
    N3=9        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h3=0.7           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_2(outer_diam_core2: float, segment_count: int):
    ...
    # Height of the core (mm)
    h4=0.5           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_3(outer_diam_core3: float, segment_count: int):
    ...
    # Height of the core (mm)
    h5=0.5           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_4(outer_diam_core4: float, segment_count: int):
    # Turns of the core
    N6=9        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h6=0.7           # PARÁMETRO QUE SE PUEDE VARIAR
...
segment_count = 1000
radius_coil_helixout = 0.00325
radius_coil_helixin  = 0.001656
radius_core = 0.0005
...
tms_coil.write("tcd/BobinaL1_ratón_PGH_1A.tcd")