...
switch coil_type
    case 'bobinaL1'
        coil.t_fall     = 40e-6;           % Tiempo de bajada (s)
        coil.wd         = 0.00075;         % Conductor diameter in m
        coil.L          = 1e-6;
        %%  Parámetros y geometría de la primera hélice (radio menor)
        coil.turns      = 2;               % Number of turns 
        coil.radius1    = 0.00675;          % Helix radius, m checks (radius2 - wd)
        coil.pitch1     = 0.0013205187;           % Pitch amplitude (separación vertical entre vueltas)
        %%  Parámetros y geometría de la segunda hélice (radio mayor)
        coil.turns2     = 1.5;
        coil.radius2    = 0.0075;
        coil.pitch2     = 0.0013129063;
    case 'bobinaL2'
        coil.t_fall     = 00e-6;
        coil.wd         = 0.0004;
        coil.L          = 1.5e-6;
