...
dIdt = I0/0.00004;              % If we are working with a square signal, we have to use the variation


%%  First helix with a varying pitch - Hanbing
turns       = 2.5;                               %   number of turns (shold be 19?)
...
d       = 0.002;                                %   conductor diameter in m (0.004 mm) 
radius1 = 0.002;                                %   helix radius, m checks
pitch1  = 0.0035;                               %   pitch amplitude
...
%%  Second helix with a larger radius
 turns       = 1;                               %   number of turns (shold be 19?)
 theta0      = turns*2*pi;                       %   how many turns (one turn is 2*pi)
% twist       = 0;                            %   twist per delta theta
% N           = 1000;                              %   subdivisions total
 theta       = linspace(0, theta0, N);           %   running angle in radians
...
radius2 = 0.0063;                                %   helix radius, m checks
pitch2  = 0.005;                               %   pitch amplitude
