addpath('C:/Users/Patriciagh/Documents/TFM/Pruebas/Matlab/Coil_Project_PGH/Coil/CoilProject05');
...
switch coilName
    case 'bobinaL1'
        ...
        Lc_min = 0.005;     Lc_max = 0.008;       % altura bobina L1 6.6mm
    case 'bobinaL2'
        p1_min = 0.0004;    p1_max = 0.005;
        p2_min = 0.0004;    p2_max = 0.005;
        Lc_min = 0.004;     Lc_max = 0.007;        % altura bobina L2 5.8mm
    case 'bobinaL3'
        p1_min = 0.00042;   p1_max = 0.004;
        p2_min = 0.00042;   p2_max = 0.004;
        Lc_min = 0.003;     Lc_max = 0.006;        % altura bobina L3 4.5mm
    case 'bobinaL4'
        p1_min = 0.0001;    p1_max = 0.006;
        p2_min = 0.0001;    p2_max = 0.006;
        Lc_min = 0.0007;    Lc_max = 0.003;        % altura bobina L4 1.8mm
    case 'bobinaL5'
        p1_min = 0.00018;   p1_max = 0.0015;
        p2_min = 0.00018;   p2_max = 0.0015;
        Lc_min = 0.0007;    Lc_max = 0.0035;        % altura bobina L5 2mm
    case 'bobinaL6'
        p1_min = 0.00007;   p1_max = 0.001;
        p2_min = 0.00007;   p2_max = 0.001;
        Lc_min = 0.0007;    Lc_max = 0.0035;        % altura bobina L6 1.6mm
    otherwise
...
T = cell2table(allRows, 'VariableNames', {'coil_type', 'turns1', 'turns2', 'r1', 'r2', 'wire_d', 'pitch1','pitch2','Lcore','Lpri', 'Lsec', 'L'});

writetable(T, 'coils_dataset_100lines_l2.csv', 'WriteVariableNames', true);
disp('CSV generado: coils_dataset_100lines_l2.csv');
format long
disp(T);
