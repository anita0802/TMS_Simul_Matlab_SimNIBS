...
radius1_valores  = linspace(r1_min,     r1_max,     N4);
...
filename = 'coils_dataset_243lines_l1.csv';
    ...
    for k = 1:N3
      for l = 1:N4
        for m = 1:N5
          ...
          coil.radius1  = radius1_valores(l);
          ...
          % crea una tabla de una sola fila con los valores
            rowT = table( ...
              ...
              core.wd, coil.pitch1, coil.pitch2, core.L, Lpri, Lsec, L, ...
              'VariableNames', {'coil_type','turns1','turns2','r1','r2','core_wd','pitch1','pitch2','Lcore','Lpri','Lsec','L'} ...
            );
