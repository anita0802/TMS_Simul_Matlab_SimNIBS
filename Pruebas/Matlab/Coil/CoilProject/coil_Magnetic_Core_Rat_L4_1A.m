...
I0 = 1;                    %   Amperes, for magnetic field
%dIdt = 2*pi*10*I0;           %   Amperes/sec (2*pi*I0/period), for electric field for 10 kHz
dIdt = I0/0.00007;              % If we are working with a square signal, we have to use the variation


%%  First helix with a varying pitch - Hanbing
turns       = 4.5;                               %   number of turns (shold be 19?)
...
d       = 0.0005;                                %   conductor diameter in m (0.004 mm) 
radius1 = 0.00075;                                %   helix radius, m checks
pitch1  = 0.0003;                               %   pitch amplitude
...
%%  Second helix with a larger radius
 turns       = 2;                               %   number of turns (shold be 19?)
 theta0      = turns*2*pi;                       %   how many turns (one turn is 2*pi)
% twist       = 0;                            %   twist per delta theta
% N           = 1000;                              %   subdivisions total
 theta       = linspace(0, theta0, N);           %   running angle in radians
...
radius2 = 0.00125;                                %   helix radius, m checks
pitch2  = 0.0006;                               %   pitch amplitude
...
% % 
% % d       = 0.0008;                                %   conductor diameter in m (0.004 mm) 
% radius3 = 0.0004;                                %   helix radius, m checks
% pitch3  = 0.0005;                               %   pitch amplitude
