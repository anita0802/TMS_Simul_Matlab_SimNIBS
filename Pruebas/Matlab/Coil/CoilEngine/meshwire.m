function [W, check] = meshwire(Pcenter, a, b, M, flag, sk, twist)
...
%   check   - ratio of AvgSegmentLength to AvgSegmentSpacing (wire mesh quality)
%   Note: to create the mesh for the end caps, either meshfill1 or meshfill2
%   can be used
%
%   SNM 2018-2021
    ...
    for m = 1:Nodes  
        ...
        if m > 1   %   define the following sets of nodes
            ...
            points          =  meshrotate2(points, UnitPathVector, (m-1)*twist);
    ...
    edges                   = W.Pwire(W.Ewire(:, 1), :) - W.Pwire(W.Ewire(:, 2), :);
