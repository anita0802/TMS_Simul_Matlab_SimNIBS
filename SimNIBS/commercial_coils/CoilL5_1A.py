...
def spiral_core(outer_diam_core: float, segment_count: int):
    # Turns of the core
    N3=20        # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_2(outer_diam_core2: float, segment_count: int):
    # Turns of the core
    N4=20       # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
...
def spiral_core_3(outer_diam_core3: float, segment_count: int):
    # Turns of the core
    N5=20        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
...
def spiral_core_4(outer_diam_core4: float, segment_count: int):
    # Turns of the core
    N6=20        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
...
tms_coil.write("tcd/BobinaL5_ratón_PGH_1A.tcd")