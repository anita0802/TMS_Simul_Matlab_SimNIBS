...
def spiral_core(outer_diam_core: float, segment_count: int):
    # Turns of the core
    N3=15        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h3=0.25           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_2(outer_diam_core2: float, segment_count: int):
    # Turns of the core
    N4=12        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
...
def spiral_core_3(outer_diam_core3: float, segment_count: int):
    # Turns of the core
    N5=12        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
...
def spiral_core_4(outer_diam_core4: float, segment_count: int):
    # Turns of the core
    N6=15        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h6=0.25           # PARÁMETRO QUE SE PUEDE VARIAR
...
segment_count = 1000
radius_coil_helixout = 0.0012
radius_coil_helixin  = 0.00031

outer_diam_core = 0.00025*1000                    # mm                  # PARÁMETRO QUE SE PUEDE VARIAR
outer_diam_core2 = 0.0002*1000
outer_diam_core3 = 0.0001*1000
outer_diam_core4 = 0.00005*1000
...
tms_coil.write("tcd/BobinaL5_ratón_PGH_05A.tcd")