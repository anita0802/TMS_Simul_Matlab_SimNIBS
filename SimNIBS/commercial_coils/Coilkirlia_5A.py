...
stimulator = TmsStimulator("Example Stimulator", "Example Stimulator Brand", 1222.2e6)
...
tms_coil.write("D:/psymulator/TMS_Simul_Matlab_SimNIBS/SimNIBS/commercial_coils/tcd/Coilkirlia_5A.tcd")