...
def spiral_core_2(outer_diam_core2: float, segment_count: int):
    # Turns of the core
    N4=16        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h4=0.3           # PARÁMETRO QUE SE PUEDE VARIAR
...
def spiral_core_3(outer_diam_core3: float, segment_count: int):
    # Turns of the core
    N5=16        # PARÁMETRO QUE SE PUEDE VARIAR
    # Height of the core (mm)
    h5=0.3           # PARÁMETRO QUE SE PUEDE VARIAR
...
tms_coil.write("tcd/BobinaL4_ratón_PGH_2A.tcd")